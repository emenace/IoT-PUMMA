const dbase_mqtt = require('../petengoran/configs/database_petengoran');
                ...
                if ((payload[TS_PATH] != null) 
                    ...
                    if (DuplicateCheck.rows[0].case === 0){ //If no duplicate then :
                        ...
                        if (checkZero.rows[0].case === 0) {
                            ...
                            WATERLEVEL = 0; VOLTAGE = 0; TEMP = 0; FORECAST30 = 0; FORECAST300 = 0;
                            RMSROOT = 0; RMSTHRESHOLD = 0; ALERTLEVEL = 0;
